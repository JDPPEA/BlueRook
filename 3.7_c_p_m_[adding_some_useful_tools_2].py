...
while follow:
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN:
            ...
            true_cordonnate_start = center_square()# les coordonnées référencée indiquent le centre d'une case
        ...
        if event.type == MOUSEBUTTONUP:
            if event.button == 1:
                ...
                true_cordonnate_end = center_square()#le centre de la case d'arrivée
...
#Cette version 3.7 rajoute le transfère du dico au processus du 3.8
