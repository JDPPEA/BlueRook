...
while follow:
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN:
            ...
            true_cordonnate = center_square()# les coordonnées référencée indiquent le centre d'une case
            code_square = give_key_with_valou(true_cordonnate)# permet de trouver la case de départ
            piece = piece_square[code_square]# permet de connaître la piece déplacée
            cordonnate=[]
...
#Cette version 3.6 amène quelques outils nécessaires à la version 3.7
